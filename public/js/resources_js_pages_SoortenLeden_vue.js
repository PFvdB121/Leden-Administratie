    ...
    soortLidOphalen: function soortLidOphalen(id) {
      ...
      if (id) {
        axios.post("soorten_leden/show", {
          ...
          _this.omschrijving = response.data.data.omschrijving;
          _this.korting = response.data.data.korting;
          _this.minLeeftijd = response.data.data.minLeeftijd;
          _this.maxLeeftijd = response.data.data.maxLeeftijd;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    deleteSoortLidALert: function deleteSoortLidALert(id) {
      var _this7 = this;
      ...
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_ion_toolbar, null, {
        "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_ion_buttons, {
            ...
            "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
              return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_ion_button, {
                disabled: !($data.omschrijving && $data.korting && $data.minLeeftijd && $data.maxLeeftijd && $data.maxLeeftijd >= $data.minLeeftijd),
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function (slotProps) {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_ion_col, {
        ...
        "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_ion_button, {
            onClick: function onClick($event) {
              return _ctx.FamilieUpdatenModal(slotProps.item);
            }
          }, {
            "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
              return [_hoisted_1];
        ...
        "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_ion_button, {
            onClick: function onClick($event) {
              return _ctx.deleteAlert(slotProps.item.id);
            },
            color: "danger"
          }, {
            "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {

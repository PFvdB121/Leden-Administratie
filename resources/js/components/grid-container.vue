<template>
    <div class="w-100" v-if="items">
        <div ref="scroll1" class="sticky-top overflow-x-scroll">
            <ion-grid class="grid-gap leden-grid">
                <ion-row class="bg-secondary">
                    <ion-col v-for="(value, key) in filterObject(gridItems[0], 'id')" :size="this.gridCols[key]">
                        {{ key }}
                    </ion-col>
                    <ion-col :size="this.gridCols.aanpassen">
                        aanpassen
                    </ion-col>
                    <ion-col :size="this.gridCols.deleten">
                        deleten
                    </ion-col>
                </ion-row>
            </ion-grid>
        ...
        <div ref="scroll2" class="overflow-x-hidden">
            <ion-grid class="grid-gap leden-grid">
                <ion-row v-for="item in gridItems" class="bg-muted">
